    ...
    public abstract class DbHelperSQLEx
    {
        ...
        public static string ConnString
        {
            get
            {
                lock (_LockObj)
                {
                    return DbHelperSQLEx.connString;
                }
            }
            set
            {
                DbHelperSQLEx.connString = value;
            }
        }
        ...
        {
            return DbHelperSQLEx.ExecuteReader(CreateSqlWhere(strWhere, orderby, startIndex, endIndex).ToString(), out err);
        }
        /// <summary>
        /// 拼接分页查询的SQL语句
        /// </summary>
