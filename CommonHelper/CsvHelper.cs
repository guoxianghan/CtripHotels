...
namespace CommonHelper
{
    public static class CsvHelper
    {
        ...
        /// <returns>DataTable</returns>
        public static DataTable OpenCSV(string fullFileName, Int16 firstRow = 0, Int16 firstColumn = 0, Int16 getRows = 0, Int16 getColumns = 0, bool haveTitleRow = true, params string[] numbercolumns)
        {
            ...
            while ((strLine = sr.ReadLine()) != null)
            {
                ...
                if (bCreateTableColumns == false)
                {
                    ...
                    for (int i = firstColumn; i < (getColumns == 0 ? columnCount : firstColumn + getColumns); i++)
                    {
                        ...
                        if (numbercolumns != null && numbercolumns.Contains(dc.ColumnName))
