...
namespace Maticsoft.DAL
{
	...
	public partial class HotelDetailServer
	{
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,HotelID,PlatID,HotelPlatID,HotelName,CreateDate,UpdateDate ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,HotelID,PlatID,HotelPlatID,HotelName,CreateDate,UpdateDate ");
            strSql.Append(" FROM HotelDetail ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
